const BLOGS = [
   {
      TITLE: `MONTH OF 2025/06/22: Film Haven: A Capstone Project`,
      SHOWN_CONTENT: `
      ...
      <img src="assets/website/blogs/2025-06-22/film_haven_logo.png" class="thumbnail img-content-2" onclick="openLightbox(src)"> <br>
      ...
      This project was created alongside one of my friends <strong><a title='Jerome "cxrtierr" Foster' href="https://www.instagram.com/rxme.png/" class="link" target="_blank">Jerome Foster</a></strong>, Using <strong>HTML (EJS)</strong>, <strong>Node.js</strong>, regular <strong>JS</strong>, and <strong>CSS</strong>.
      ...
      Around the start of development (like mid-late 2024), the API was very limited, so we only used a selected amount of features like "Genres", and "Watchlists"
      .
      ...
      The prototype was completed within a 2 week range. It was made from scratch, using regular <strong>HTML</strong>, <strong>CSS</strong> & <strong>JS</strong>. The WHOLE prototype was programmed by Jerome, while I tweaked the code afterwards.

      <br> <br>
      <strong class="blog-headings-medium">JEROMES PROTOTYPE:</strong> <br> <br>
      <img src="assets/website/blogs/2025-06-22/film_haven_proto.png" class="thumbnail img-content-3" onclick="openLightbox(src)">
      ...
      <img src="assets/website/blogs/2025-06-22/film_haven_results.png" class="thumbnail img-content-3" onclick="openLightbox(src)">
      ...
      <img src="assets/website/blogs/2025-06-22/film_haven_final.png" class="thumbnail img-content-2" onclick="openLightbox(src)">

      <br> <br>
      <strong class="blog-headings-medium">MOVIE DETIALS:</strong> <br>
      <img src="assets/website/blogs/2025-06-22/film_haven_details.png" class="thumbnail img-content-2" onclick="openLightbox(src)">
      ...
      <br> <br>
      <strong class="blog-headings-medium">Written By: Aaron Augustin | UPDATED: 2026/01/26</strong>
      `
   },

   {
      TITLE: `MONTH OF 2025/04/18: A FRESH START / SOURCE CODE OVERHAUL`,
      SHOWN_CONTENT: `
      <strong class="blog-headings-large">Introduction</strong> <br>
      ...
      <img src="assets/website/blogs/2025-04-18/project_code_BEFORE.png" class="thumbnail img-content-2" onclick="openLightbox(src)">

      <br> <br>
      <strong class="blog-headings-medium">After:</strong> <br> <br>
      <img src="assets/website/blogs/2025-04-18/project_code_AFTER.png" class="thumbnail img-content-2" onclick="openLightbox(src)">
      ...
      <img src="assets/website/blogs/2025-04-18/source_code_overhaul_OLD.png" class="thumbnail img-content-1" onclick="openLightbox(src)">

      <br> <br>
      <strong class="blog-headings-medium">Updated Workspace:</strong> <br> <br>
      <img src="assets/website/blogs/2025-04-18/source_code_overhaul_NEW.png" class="thumbnail img-content-1" onclick="openLightbox(src)">
      ...
      <img src="assets/website/blogs/2025-04-18/fnf_fde_gameplay.png" class="thumbnail img-content-2" onclick="openLightbox(src)">
      ...
      <br> <br>
      <strong class="blog-headings-medium">Written By: Aaron Augustin | Updated: 2025/04/22</strong>`
   }
];